<h2><a href="https://www.geeksforgeeks.org/problems/java-streams-average/1?page=1&category=Java&status=unsolved,attempted&sortBy=submissions">Java Streams Average</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an integer array <strong>arr[]</strong>. The task is to find the<strong> average </strong>of the array using streams.</span></p>
<blockquote>
